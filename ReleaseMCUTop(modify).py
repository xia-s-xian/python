...
top_project_dir = r"F:\8.ZGW\4_VA9638项目\18_集成发布\VA9638B_V8000_MultiCore\coretop"
output_zip_dir = r"F:\8.ZGW\4_VA9638项目\18_集成发布" 
...
#   proj_dir = os.path.abspath(os.path.dirname(PROJ_FILE))
    ...
    src_root_dir = os.path.abspath(proj_dir + r"\..")
    #output_dir = os.path.abspath(
    #os.path.join(os.path.dirname(src_root_dir)))
    #文件输出路径
    output_dir=output_zip_dir
    ...
    CopyFileToZip(src_list, output_zipfile)
    print("--- done ----")
