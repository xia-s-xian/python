...
#copy debug_info
    ...
    tDir="F:/8.ZGW/4_VA9638项目/18_集成发布/daily_build_note/"+file_dir+"/Code_SRC/debuginfo"
...
def fun_cp_eck():
    ...
    top_s="D:/4_ZGW/VimcBT/VA9638B/ECK/Tri-Mode/9638B_6_8_ECK_TriCore_TriMode_V0.2.7_multilink.vfi"
    top_d="F:/8.ZGW/4_VA9638项目/18_集成发布/daily_build_note/"+file_dir+"/ECK"
    shutil.copy(top_s,top_d)
